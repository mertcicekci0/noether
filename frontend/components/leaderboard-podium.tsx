  ...
  return (
    <div className="grid grid-cols-3 gap-4 lg:gap-6 items-end">
      {topTraders.map((trader) => {
        const styles = colorStyles[trader.color as keyof typeof colorStyles]
          ...
          >
            ...
            <div className={`p-5 ${isFirst ? "lg:p-6" : ""} pt-8`}>
              ...
              <div className="text-center">
                ...
                {/* PnL */}
                <div className={`inline-block px-3 py-1.5 rounded-lg bg-profit/10 mb-3`}>
                  <span className="font-mono text-xl font-bold text-profit">{trader.pnl}</span>
                  <span className="text-xs text-profit/70 ml-1">ROI</span>
                </div>
