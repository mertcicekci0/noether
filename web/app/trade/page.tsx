...
function TradePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]" style={{ backgroundImage: 'url(/trade-background.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
      <Header />
