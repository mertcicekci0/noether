...
function PortfolioPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]" style={{ backgroundImage: 'url(/portfolio-background.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed', backgroundColor: 'rgba(10,10,10,0.5)', backgroundBlendMode: 'overlay' }}>
      <Header />
